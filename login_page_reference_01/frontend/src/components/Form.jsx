    ...
    <div className="bg-wihite px-10 py-20 rounded-3xl border-2 border-gray-300">
      ...
      <div className="mt-8">
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          <button className="active:scale-[.98] hover:scale-[1.01] ease-in-out active:duration-75 transition-all py-3 rounded-xl bg-violet-500 text-white text-lg font-bold">
            Sign in
          </button>
